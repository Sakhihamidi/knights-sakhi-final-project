...
public class Login {
    ...
    public final static By passwordField = By.xpath("//div/form/div/div[2]/div/input");

    public final static By logInButton = By.xpath("//div[1]/div/div[1]/div/a[2]");

    public final static By signInButton = By.xpath("//div/div/form/div/div[3]/button[1]");
